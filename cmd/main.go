...
import (
	...
	"github.com/colonyos/kolony/internal/controller"
...
func init() {
	...
	utilruntime.Must(colonyv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4fdf7221.colonyos.io",
	...
	if err := (&controller.BlueprintDefinitionReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "BlueprintDefinition")
		os.Exit(1)
	}
